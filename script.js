...
const messages = [
    { text: "Hello, esteemed Dean of Admissions! ✨ I am thrilled to inform you that I have discovered an exceptional student, just as you requested. I couldn't contain my excitement when I came across this promising applicant. They truly warrant your immediate attention.", speaker: "stanfordtree" },
    ...
    { text: "Dear dean, at Stanford, we unearth dreams from forgotten pages, turning ordinary narratives into bestselling tales. This unique essence drew Mr. Sanil to choose Stanford as his first choice, amidst over 5000 magical schools.", speaker: "stanfordtree" },
    ...
    { text: "The Stanford Tree, your dedication to discovering and advocating for exceptional talent is truly commendable. As we welcome Mr. Sanil to the class of 2028, we embrace the belief in the magic of unique opportunities. Together, let's embark on a journey of limitless possibilities.", speaker: "dean" },
];
...
function displayMessage() {
    if (index < messages.length) {
        ...
        if (message.speaker === "stanfordtree" || message.speaker === "dean") {
...
function createMessageElement(message) {
    ...
    avatar.classList.add('avatar', message.speaker === 'stanfordtree' ? 'sent' : 'received');
    ...
    nameElement.textContent = message.speaker === 'stanfordtree' ? 'The Stanford Tree' : 'Dean';
